            ...
            var PageVisitTimeManager = (function () {
                ...
                PageVisitTimeManager.prototype.trackPreviousPageVisit = function (currentPageName, currentPageUrl) {
                    try {
                        ...
                        if (prevPageVisitTimeData) {
                            this.pageVisitTimeTrackingHandler(prevPageVisitTimeData.actionType, prevPageVisitTimeData.pageUrl, prevPageVisitTimeData.pageVisitTime);
                        }
                    }
                    catch (e) {
                ...
                PageVisitTimeManager.prototype.restartPageVisitTimer = function (pageName, pageUrl) {
                    try {
                        ...
                        this.startPageVisitTimer(actionType, pageUrl);
                ...
                PageVisitTimeManager.prototype.startPageVisitTimer = function (pageName, pageUrl) {
                    try {
                        if (ApplicationInsights.Util.canUseSessionStorage()) {
                            ...
                            var currPageVisitData = new PageVisitData(actionType, pageUrl);
    ...
    (function (ApplicationInsights) {
        ...
        var AppInsights = (function () {
            function AppInsights(config) {
                ...
                this._pageVisitTimeManager = new ApplicationInsights.Telemetry.PageVisitTimeManager(function (pageName, pageUrl, pageVisitTime) { return _this.trackPageVisitTime(actionType, pageUrl, pageVisitTime); });
            ...
            AppInsights.prototype.trackPageVisitTime = function (pageName, pageUrl, pageVisitTime) {
                var properties = { PageName: actionType, PageUrl: pageUrl };
