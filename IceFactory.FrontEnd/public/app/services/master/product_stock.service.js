...
IceFactory.factory("productStockService", function ($http, $q, $rootScope, handlerService) {
    let uri = $rootScope.settings.apiUrl + "admin/productstock";
    ...
    function getview(data) {
        let request = $http.post(uri + "/getview", data);
        return (request.then(handlerService.handlerSuccess, handlerService.handlerError));
    }
